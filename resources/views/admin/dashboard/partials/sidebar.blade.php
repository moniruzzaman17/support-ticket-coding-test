...
<div class="accordion" id="adminInfoWrapper">
    <div class="accordion-item">
      <h2 id="singleHeadingFirst" class="accordion-header">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#adminInfo" aria-expanded="true" aria-controls="adminInfo">
            <i class="fas fa-user"></i> &nbsp; {{ Auth::guard('administrator')->user()->name }}
        </button>
      </h2>
      <div id="adminInfo" class="accordion-collapse collapse show" aria-labelledby="singleHeadingFirst">
        <div class="accordion-body">
          <p class="mb-0">Name: {{ Auth::guard('administrator')->user()->name }}</p>
          <p class="mb-0">Email: {{ Auth::guard('administrator')->user()->email }}</p>
        </div>
      </div>
    </div>
</div>
